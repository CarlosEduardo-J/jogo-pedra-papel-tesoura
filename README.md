...
Este projeto utiliza apenas ferramentas nativas do Python:

* **Linguagem:** Python 3.x
* **Módulos Nativos:** Utilização do módulo `random` para a escolha da máquina.

## 📁 Estrutura do Projeto

Por ser um projeto em um único arquivo, a estrutura é bem simples:

```bash
jogo-pedra-papel-tesoura/
├── jogo_pedra_papel_tesoura.py   # 🎯 Lógica principal do jogo
└── README.md
```
